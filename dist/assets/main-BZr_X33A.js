...
#define LOW_PRECISION`),e}function fS(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Rp?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===k_?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Zi&&(e="SHADOWMAP_TYPE_VSM"),e}function dS(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case oo:case ao:e="ENVMAP_TYPE_CUBE";break;case Ql:e="ENVMAP_TYPE_CUBE_UV";break}return e}function pS(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case ao:e="ENVMAP_MODE_REFRACTION";break}return e}function mS(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Cp:e="ENVMAP_BLENDING_MULTIPLY";break;case rg:e="ENVMAP_BLENDING_MIX";break;case sg:e="ENVMAP_BLENDING_ADD";break}return e}function _S(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function gS(s,e,t,n){const i=s.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=fS(t),c=dS(t),u=pS(t),h=mS(t),f=_S(t),d=rS(t),g=sS(r),_=i.createProgram();let m,p,S=t.glslVersion?"#version "+t.glslVersion+`
